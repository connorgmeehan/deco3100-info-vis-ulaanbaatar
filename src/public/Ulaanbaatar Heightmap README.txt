...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Ulaanbaatar+Heightmap&box=107.037426,48.004542,106.795753,47.842845
...
-----------
  ...
  * Ulaanbaatar Heightmap Height Map (ASTER 30m).png
  ...
  * Ulaanbaatar Heightmap Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Ulaanbaatar Heightmap Height Map (SRTM3 v4.1).png
  ...
  * Ulaanbaatar Heightmap Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 1210m (actual) is equal to 40m in
